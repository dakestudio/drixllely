    ...
    return (
      <section id="rsvp-section" className="py-24 bg-[#FCFBF5] text-center px-6">
        ...
        >
          ...
          <h2 className="font-serif italic text-2xl text-[#381031] mb-3">Invitación no encontrada</h2>
          <p className="font-sans text-[#381031]/70 text-sm font-light leading-relaxed">
    ...
    return (
      <section id="rsvp-section" className="py-24 bg-[#FCFBF5] text-center px-6">
        <motion.div
          ...
          className="max-w-md mx-auto bg-white p-10 rounded-sm shadow-md border border-[#A8ABAE]/20"
        >
          <WifiOff className="w-12 h-12 mx-auto mb-4 text-[#A8ABAE]" />
          <h2 className="font-serif italic text-2xl text-[#381031] mb-3">Sin conexión</h2>
          <p className="font-sans text-[#381031]/70 text-sm font-light leading-relaxed mb-6">
            No pudimos cargar tu invitación. Revisa tu conexión a internet e inténtalo de nuevo.
          </p>
          <button
            type="button"
            onClick={() => window.location.reload()}
            className="px-8 py-3 border border-[#536332] text-[#536332] hover:bg-[#536332] hover:text-[#FCFBF5] transition-all duration-500 text-xs uppercase tracking-[0.25em] font-medium rounded-full"
          >
            Reintentar
          </button>
        </motion.div>
    ...
    return (
      <section className="py-24 bg-[#FCFBF5] text-center px-6">
        ...
        >
          ...
          <h2 className="font-serif italic text-3xl text-[#381031] mb-3">¡Ya confirmaste, {invitado.nombre}!</h2>
          <p className="font-sans text-[#381031]/80 text-sm font-light">
    ...
    return (
      <section id="rsvp-section" className="py-24 bg-[#FCFBF5] text-center px-6 min-h-[60vh] flex items-center justify-center">
        ...
        >
          ...
          <h2 className="font-serif italic text-3xl md:text-4xl text-[#381031] mb-4">¡Respuesta Confirmada!</h2>
          <p className="font-sans font-light text-[#381031]/80 mb-4 leading-relaxed text-sm md:text-base">
          ...
          {invitado && (
            <p className="font-sans text-xs tracking-widest uppercase text-[#A8ABAE] mt-6 pt-6 border-t border-[#A8ABAE]/20">
              Invitación registrada para: <span className="text-[#381031] font-medium">{invitado.nombre}</span>
            </p>
          )}
        </motion.div>
      </section>
      ...
      <section className="py-24 bg-[#FCFBF5] relative overflow-hidden">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h2 className="font-serif italic text-4xl sm:text-5xl text-[#381031] mb-3">RSVP</h2>
            ...
            <div className="bg-white p-8 md:p-12 border border-[#A8ABAE]/30 shadow-lg max-w-lg mx-auto rounded-sm space-y-4">
              <p className="font-sans text-[#381031]/80 text-sm leading-relaxed font-light">
  ...
  return (
    <section id="rsvp-section" className="py-24 md:py-32 bg-[#FCFBF5] relative overflow-hidden">
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="font-serif italic text-4xl sm:text-5xl md:text-6xl text-[#381031] mb-3">Confirmación</h2>
        ...
        {/* Form Container */}
        <form onSubmit={handleSubmit} className="space-y-10 bg-white p-8 md:p-14 shadow-[0_20px_50px_-20px_rgba(56,16,49,0.12)] border border-[#A8ABAE]/20 rounded-sm">
          
          {/* Teléfono */}
          <div className="flex flex-col">
            <label htmlFor="rsvp-telefono" className="font-sans text-xs uppercase tracking-[0.2em] text-[#A8ABAE] mb-3">
            ...
            <input
              ...
              maxLength={16}
              className="bg-transparent border-b border-[#A8ABAE]/50 py-3 focus:outline-none focus:border-[#536332] transition-all font-serif text-xl text-[#381031]"
              ...
              <button
                ...
                className={`px-8 py-3.5 border transition-all duration-500 text-xs tracking-[0.2em] uppercase rounded-full font-medium ${
                  formData.asistira === 'yes'
                    ...
                    : 'border-[#A8ABAE]/40 text-[#381031]/70 hover:border-[#536332]'
                }`}
              >
                Sí, asistiré
              </button>
              <button
                ...
                className={`px-8 py-3.5 border transition-all duration-500 text-xs tracking-[0.2em] uppercase rounded-full font-medium ${
                  formData.asistira === 'no'
                    ? 'bg-[#381031] text-[#FCFBF5] border-[#381031] shadow-md'
                    : 'border-[#A8ABAE]/40 text-[#381031]/70 hover:border-[#381031]'
                }`}
              >
                No podré asistir
              </button>
                      ...
                      {formData.nombresAcompanantes.map((name, index) => (
                        ...
                        >
                          <input
                            ...
                            className="w-full bg-transparent border-b border-[#A8ABAE]/40 py-2 focus:outline-none focus:border-[#536332] font-serif text-lg text-[#381031]"
                    ...
                    <button
                      ...
                      className={`px-6 py-2 border transition-all text-xs tracking-widest uppercase rounded-full ${
                        formData.tieneRestricciones === false
                          ...
                          : 'border-[#A8ABAE]/40 text-[#381031]/70'
                      }`}
                    >
                      No
                    </button>
                    ...
                    {formData.tieneRestricciones && (
                      ...
                      >
                        <textarea
                          ...
                          rows={2}
                          className="w-full bg-transparent border-b border-[#A8ABAE]/50 py-2 focus:outline-none focus:border-[#536332] font-serif text-lg text-[#381031] resize-none"
              ...
              >
                <div className="flex flex-col">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="bg-transparent border-b border-[#A8ABAE]/50 py-2 focus:outline-none focus:border-[#536332] font-serif text-lg text-[#381031] resize-none"
          ...
          {formData.asistira !== null && (
            <div className="text-center pt-6">
              <button
                ...
                className="bg-[#536332] text-[#FCFBF5] px-12 py-4 font-sans text-xs uppercase tracking-[0.25em] hover:bg-[#381031] transition-all duration-500 rounded-full shadow-lg disabled:opacity-50"
              >
                {status === 'submitting' ? (
